...
export const projs = [
    {
        slug: "houz",
        name: "Houz",
        description: "This project is an online marketplace just as an Airbnb, but I wanted to make easy user-interface for the people in my country for short-and-long-term homestays. It acts as a broker and charges a commission from each booking.",
...

    {
        ...
        images: ["/peace/1.jpeg", "/peace/2.jpeg", "/peace/3.jpeg"],
        role: "Founder",
        date: "2023 - 2024"
    },
    {
        slug: "f-h-d",
        name: "F.H.M",
        description: 'FaceID check-in system for hotels, made in 2 days using open source python library "opencv-python".',
    ...
    },
    {
        slug: "atm",
        name: "ATM",
        description: "Fast realtime ATM with real currency conversions from 7 globally used currencies which you wouldn't see all these in one ATM. It scrapes realtime data from a website, then you are good to go whether you choose to withdraw or deposit the money into your account.",
        date: "1 day"
    },
];